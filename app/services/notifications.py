...
Infraestrutura de envio (enviar_email, links, resolver_importance) vive em
notifications_core.py — reimportada aqui para manter os patches de teste
existentes (`app.services.notifications.enviar_email` etc.) funcionando,
já que todo notificar_* abaixo permanece neste módulo.
"""
...
# ---------------------------------------------------------------------------
# SLA Resolução — Fase 7 (Escada B) — movida para notifications_escalonamento.py
# ---------------------------------------------------------------------------
